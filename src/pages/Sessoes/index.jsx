...
export default function Sessoes() {
    ...
    const filteredTimes = sessions.filter(session => {
        const matchesCity = selectedCity ? selectedCity === session.cidade : true
        const matchesNeighborhood = selectedNeighborhood ? selectedNeighborhood === session.bairro : true
